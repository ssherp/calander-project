...
$(function () {
  ...
  //create a var that save the current time and use day.js
  //get the current time block, loop over the blocks, apply the style based on what day.js return
  //compare the block time and the current time
